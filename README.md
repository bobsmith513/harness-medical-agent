...
```mermaid
flowchart TD
    A["<b>步骤 0：脱敏中间件</b><br/>输入: 张明（身份证 310101198001011234）...电话 13812345678<br/>输出: 张明（身份证 [REDACTED-ID]）...电话 [REDACTED-PHONE]<br/>移除: ID, PHONE"]
    ...
    G["<b>步骤 6：临床结论</b><br/>结论: CAP 经验性治疗：阿奇霉素 500mg qd × 3-5 天<br/>产出者: reasoning_expert<br/>引用证据: ev-1<br/>结论ID: cc-3e20167f6dae"]
...
步骤 0：脱敏中间件前置
========================================================================
  原始输入: 张明（身份证 310101198001011234）咳嗽三天，发烧 38.5 度，
            之前打盘尼西林过敏，用药方案怎么定？电话 13812345678
  脱敏后:   张明（身份证 [REDACTED-ID]）咳嗽三天，发烧 38.5 度，
            之前打盘尼西林过敏，用药方案怎么定？电话 [REDACTED-PHONE]
  移除标识: ID:310101198001011234, PHONE:13812345678
...
========================================================================
  ...
  阻断药物: （无）
  [命中] [ev-1] CAP 患者若对 β-内酰胺类过敏，可选大环内酯类
          （阿奇霉素）替代。阿奇霉素 500mg qd，疗程 3-5 天
...
========================================================================
  ...
  引用证据: ['ev-1']
  结论ID: cc-3e20167f6dae

========================================================================
步骤 7：全链路 trace 事件
========================================================================
  [TRACE] route: {'decision': 'need_reasoning', 'by_rule': True}
  [TRACE] retrieve: {'query': '咳嗽三天伴发热，用药方案怎么定？', 'evidence_count': 3}
  [TRACE] reason: {'chain_steps': 3, 'self_check': True}
  [TRACE] gate_check: {'quality': 'pass', 'drug_safety': 'pass'}
  [TRACE] conclude: {'statement': '阿奇霉素 500mg qd × 3-5 天'}
  全链路事件总数: 5
...
========================================================================
  ...
  提交审核: memory_id=mem-3c3e01a56105...
  状态: pending_review
  可召回: 否

  自动审核（doctor_verified + high 自动通过）:
    mem-3c3e01a56105... → approved (高置信度自动通过)
...
========================================================================
  ...
  路由: need_reasoning
  结论: （被门禁拦截，未交付）
  门禁 quality_judge: 通过 — 质量门禁通过：忠实度 0.95 >= 0.7
...
========================================================================
  ...
  门禁 quality_judge: 通过 — 质量门禁通过：忠实度 0.92 >= 0.7
